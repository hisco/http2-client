...
class HttpRequestManager extends EventEmitter{
 ...
 tryToSetModule(name){
  ...
  makeHttpRequest(clientKey , inStream , options , cb , connectionOptions){
    ...
    h1op.protocol = options.protocol;
    h1op.hostname = options.hostname;
    h1op.port = options.port;
    h1op.path = options.pathname + options.search;
  ...
  makeHttp2Request(clientKey , inStream , http2Client , requestOptions , cb){
      ...
      req.once('response' , function onResponse(headers){
